...
<div class="bg-white">
    ...
    <div class="relative  flex justify-center items-center h-96">
     ...
     <div class="absolute size-full bg-black/60"></div>
        <p class="z-10 relative  md:!text-6xl !text-2xl  text-gray-100 font-bold">SOLO UN CAFÉ</p>
    </div>
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <section class="mb-12">
         ...
         <div class="flex flex-wrap gap-3">
          ...
          <?php
        mostrar_noticias_por_categoria('solo-un-cafe');
        mostrar_podcasts_por_categoria('solo-un-cafe');
        ?>
