        ...
        <div class="grid md:grid-cols-4 w-full max-w-screen-xl p-4">
            ...
            <div class="p-2 md:block flex gap-5 items-center">
                ...
                <ul class="flex gap-3 text-gray-400 items-center md:py-8 ">
                    <li> <a   aria-label="Ir a Facebook" href="https://www.facebook.com/unslradio/?locale=es_LA" target="_blank">
                            <img width="35" height="35" src="https://upload.wikimedia.org/wikipedia/commons/b/b8/2021_Facebook_icon.svg" alt="Facebook de UNSL Radio">

                        </a>
                    </li>
                    <li> <a  aria-label="Ir a Instagram" href="https://www.instagram.com/unslradio/?hl=es" target="_blank">
                            <img width="35" height="35" src="<?php echo get_template_directory_uri(); ?>/assets/images/Instagram_logo_2016.svg" alt="Instagram de UNSL Radio">
                        </a>
                    </li>
                    <li> <a  aria-label="Ir a Youtube" href="https://www.youtube.com/@radiounslcontenidos" target="_blank">
                            <img width="35" height="35" src="https://freelogopng.com/images/all_img/1656501968youtube-icon-png.png" alt="YouTube de UNSL Radio">
                        </a>
                    </li>
                </ul>
            </div>
...
background: linear-gradient(0deg, rgba(249,250,251,0.9) 30%, rgba(212,212,212,0.9) 100%);">
    ...
    <div id="radio" class="container-4 md:hidden absolute flex justify-center w-full items-center md:gap-5 gap-1" style="left:-49px;">
        ...
        <button type="button" data-modal-target="modal" data-modal-toggle="modal">
            <div class="sr-only">Compartir</div>
