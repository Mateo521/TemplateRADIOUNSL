    ...
    <div class="flex justify-center">
        ...
        <div style="max-width: 640px;width: 100%;">
            ...
            <form class="p-6" method="post" action="">
                ...
                <button name="contact_form_submit" style="position: relative; left: 50%; transform: translateX(-50%); background-color: #486faf; margin: 50px 0 100px 0;" type="submit" class=" text-white  cursor-pointer  hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600">Enviar
                    mensaje</button>
            </form>
        </div>
    </div>
