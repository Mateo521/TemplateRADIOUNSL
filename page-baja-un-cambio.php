...
<div class="bg-white">
    ...
    <div class="relative  flex justify-center items-center h-96">
        ...
        <p class="z-10 relative  md:!text-6xl !text-2xl  text-gray-100 bold">BAJÁ UN CAMBIO</p>
    </div>
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <a href="<?php the_permalink(); ?>">
                        <article class="w-64 bg-white rounded shadow-sm overflow-hidden flex-shrink-0 flex flex-col">
                            ...
                            <div class="p-3 flex-1 flex flex-col justify-between">
                                <p class="text-sm text-[#2a6ad1] font-semibold uppercase mb-1">BAJÁ UN CAMBIO</p>
        ...
        <section>
            <h2 class=" sm:text-sm font-normal mb-4">Últimos podcasts de Bajá un Cambio</h2>
